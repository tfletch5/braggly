      ...
      <div className="container-custom relative">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-white/20 px-4 py-2 text-sm text-white backdrop-blur-sm">
            ...
            <span>The 5-Layer AI Marketing Stack</span>
          </div>
          ...
          <h1 className="mb-6 text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
            ...
            <br />
            <span className="text-white/90">Start Running a Marketing Machine.</span>
          </h1>

          {/* Subheadline */}
          <p className="mb-8 text-lg text-white/90 sm:text-xl lg:text-2xl">
            We build the 5 layers every business needs — content, distribution,
            lead capture, nurture, and follow-up — so your marketing generates,
            nurtures, and closes leads automatically.
          </p>
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-6 text-sm text-white/80">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Start with just 2 layers</span>
            </div>
          </div>
        </div>
      </div>
